...
from src.warehouse.db.init_db import initialize_database

@patch("src.warehouse.db.init_db.get_db_engine")
@patch("src.warehouse.db.init_db.os.path.exists")
...
@patch("src.warehouse.db.init_db.logging.error")
@patch("src.warehouse.db.init_db.os.path.exists")
@patch("src.warehouse.db.init_db.get_db_engine")
