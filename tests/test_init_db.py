...
from warehouse.init_db import initialize_database

@patch("warehouse.init_db.get_db_engine")
@patch("warehouse.init_db.os.path.exists")
...
@patch("warehouse.init_db.logging.error")
@patch("warehouse.init_db.os.path.exists")
@patch("warehouse.init_db.get_db_engine")
